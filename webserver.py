...
# -------------
  ...
  # TODO: Assign a port number 8080 is port number typically used, could be any 4?
  #should this be empty?
socketPort = 8081
  #       Bind the socket to server IP address and server port (IP address in Kaia's room at Smith)
